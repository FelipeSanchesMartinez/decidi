        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedFreelancerId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_AspNetUsers_AcceptedFreelancerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerProfileSkill", x => new { x.FreelancerProfilesId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_FreelancerProfileSkill_FreelancerProfiles_FreelancerProfile~",
                        column: x => x.FreelancerProfilesId,
                        principalTable: "FreelancerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FreelancerProfileSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Conversations_AspNetUsers_FreelancerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_ProjectId_ClientId_FreelancerId",
                table: "Conversations",
                columns: new[] { "ProjectId", "ClientId", "FreelancerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerProfileSkill_SkillsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proposals_FreelancerId_ProjectId",
                table: "Proposals",
                columns: new[] { "FreelancerId", "ProjectId" },
                unique: true);
